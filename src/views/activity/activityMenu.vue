<template>
  <div class="merchant">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.importance" placeholder="活动名称" clearable style="width: 90px" class="filter-item">
      ...
      <el-select v-model="listQuery.sort" placeholder="活动类型" style="width: 140px" class="filter-item" @change="handleFilter">
      ...
      <el-table-column label="活动id" prop="id" sortable="custom" align="center" width="128">
        <template slot-scope="scope">
          <span>{{ scope.row.id }}</span>
			...
			<el-table-column label="活动名称" prop="id" align="center" min-width="100">
        <template slot-scope="scope">
          <span>{{ scope.row.id }}</span>
        </template>
      </el-table-column>
