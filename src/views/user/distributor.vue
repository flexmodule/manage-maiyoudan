<template>
  <div class="distributor">
    <div class="filter-container">
      <el-input placeholder="分销者id" v-model="listQuery.title" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter"/>
        ...
        <el-option v-for="item in sortOptions" :key="item.key" label="item.label" :value="item.key"/>
			...
			<el-select v-model="listQuery.sort" placeholder="状态" style="width: 140px" class="filter-item" @change="handleFilter">
        <el-option v-for="item in sortOptions" :key="item.key" label="item.label" :value="item.key"/>
      </el-select>
